...
function Category() {
  ...
  const handleAddCategory=async()=>{
        ...
        if(response.status==201){
            toast.success(`succefully inserted ${categoryName}`);
            handleClose();
        }
        else{
  ...
  return (
   ...
   >
     <Modal.Header closeButton>
       <Modal.Title><i class="fa-solid fa-list me-2 "></i>Upload a video</Modal.Title>
     </Modal.Header>
     <Modal.Body>
     <p>Please fill the form</p>
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Control type="text" placeholder="Enter video catgory  name" onChange={(e)=>setCategoryName(e.target.value)} />
      </Form.Group>
